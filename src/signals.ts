...
function addDependency(signal: Signal): Node | undefined {
  ...
  console.log('signal._node:', node);
	if (node === undefined || node._target !== evalContext) {
    console.log('evalContext._sources:', evalContext._sources);
...
Computed.prototype._refresh = function () {
  console.log("Computed._refresh:_flags", flagsToString(this._flags));
  ...
  console.log(flagsToString(this._flags & (OUTDATED | TRACKING)));
	// if (!(this._flags & OUTDATED) && (this._flags & TRACKING)) {
	if ((this._flags & (OUTDATED | TRACKING)) === TRACKING) {
		return true;
	}
	this._flags &= ~OUTDATED;

  console.log("this._globalVersion:", this._globalVersion, "globalVersion:", globalVersion);
